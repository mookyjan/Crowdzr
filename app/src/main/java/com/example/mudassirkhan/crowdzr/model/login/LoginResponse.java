package com.example.mudassirkhan.crowdzr.model.login;
...
public class LoginResponse extends BaseResponse {
    ...
    public class User {
        ...
        @Expose
        private List<String> mayBeInterestedShoutouts = null;
        ...
        public List<String> getMayBeInterestedShoutouts() {
            return mayBeInterestedShoutouts;
        }

        public void setMayBeInterestedShoutouts(List<String> mayBeInterestedShoutouts) {
